...
interface Coin98Window extends Window {
  coin98Aptos?: PluginProvider;
}

declare const window: Coin98Window;

export const Coin98WalletName = "Coin98 Aptos" as WalletName<"Coin98 Aptos">;

// CHANGE AptosWallet
export class Coin98Wallet implements AdapterPlugin {
  readonly name = Coin98WalletName;
  readonly url =
    "https://chrome.google.com/webstore/detail/coin98-wallet/aeachknmefphepccionboohckonoeemg"; // CHANGE url value
